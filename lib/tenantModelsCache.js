...
export const getTenantModels = (tenantId) => {
  if (!tenantModelPromises.has(tenantId)) {
    const promise = (async () => {
      ...
      return { brandModelDB, categoryModelDB, productModelDB, saleTrendModelDB, productReviewsModelDB, cartModelDB, wishlistModelDB, userModelDB, orderModelDB, otpModelDb, deviceSessionModelDB, notificationModelDB };
    })();
